...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-5#t=xauv*+t4ll=kl5l4l+uoo1!adb=r7$b-yii&tnr+7q@_y5')
...
TEMPLATES = [
    {
        ...
        'DIRS': [Path('/frontend/templates')],  # Frontend templates (works in both dev and Docker)
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
